...
builder.Services.AddDbContext<AppDbContext>(db =>
            db.UseSqlServer(connectionString, b => b.MigrationsAssembly("MSEmail.Infra")));

builder.Services.AddControllers();

var key = Encoding.UTF8.GetBytes(builder.Configuration.GetSection("AppSettings")
    .GetValue<string>("TokenSecret"));
